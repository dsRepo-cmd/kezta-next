...
export default function Page({ children, navigation }: PageProps) {
  return (
    <div className=" relative flex flex-col min-h-screen  bg-black overflow-hidden mb-40 sm:mb-20">
      <Header>
        <LogoIcon />
      ...
      <Label />
      <FollowLink />
      <main className=" mx-auto w-[70%] flex gap-5 pr-40 sm:mx-1 sm:w-full sm:pr-4">
        <Divider vertical />
